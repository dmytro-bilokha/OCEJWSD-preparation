...
public interface SoapCountryService {
    ...
    @Action(input = "http://tomcatmetrosoap.bilokhado/SoapCountryService/getCountryRequest", output = "http://tomcatmetrosoap.bilokhado/SoapCountryService/getCountryResponse")
